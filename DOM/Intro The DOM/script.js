...
console.log(document.links[0]);//Bir sayfadaki linkleri alabiliriz.Indekslerle de direkt linki alabiliriz
...
document.write('Hello from JS');//sayfanın en sonuna koyar o yuzden cok kullanılmaz.
